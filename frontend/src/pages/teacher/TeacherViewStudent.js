...
import { Box, Button, Collapse, Table, TableBody, TableHead, Typography,Grid,Card,CardContent} from '@mui/material';
...
const TeacherViewStudent = () => {
    ...
    return (
        <>
          ...
          <h3 style = {{marginTop: "40px", marginBottom: "20px"}}>Attendance:</h3>

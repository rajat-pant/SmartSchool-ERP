...
import { Box, Button, Collapse, IconButton, Table, TableBody, TableHead, Typography, Tab, Paper, BottomNavigation, BottomNavigationAction, Container,Grid,
    Card,
...
import ViewStudentImg from "../../../assets/ViewStudent.png";
...
const ViewStudent = () => {
    ...
    const StudentDetailsSection = () => {
        ...
        <Grid
          ...
          marginTop = "1px"
        >
          <Grid item xs={12} sm={6} container direction="column" spacing={3} height = "600px">
            <Grid item>
              <Card
                sx={{
                  minWidth: 275,
          ...
          <Grid item xs={12} sm={6} >
            <Card
              sx={{ boxShadow: 3, backgroundColor: "#f5f5f5" }}
              >
              <CardContent>
                <Typography variant="h5" component="h2">Attendance </Typography>
                <Box
                  display="flex"
                  justifyContent="center"
                  alignItems="center"
